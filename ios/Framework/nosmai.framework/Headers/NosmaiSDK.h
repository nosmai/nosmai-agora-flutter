 ...
 *
 * @return SDK version string (e.g., "2.0.0")
 */
+ (NSString*)version;
...
/**
 * Sets a STRING parameter value for the currently loaded effect.
 * This will not affect older filters.
 */
- (BOOL)setEffectParameter:(NSString*)parameterName
...
/**
 * [TESTING] Fetches filters using the new folder-based approach.
 * Scans a main "Nosmai_Filters" directory for subdirectories, where each
 * subdirectory represents a single filter.
 *
 * @return A dictionary of filters organized by type, similar to
 * getInitialFilters.
 */
- (NSDictionary<NSString*, NSArray<NSDictionary*>*>*)getLocalFilters;
...
// Deprecated - Use getLocalFilters instead
// /**
